...
- **Cybersecurity:** Segurança de sistemas, análise de vulnerabilidades em sistemas e redes, Pentest básico, Criptografia  
- **IoT & Automação:** Arduino, ESP32, sensores e atuadores  
- **Ferramentas:** Linux, Git, GitHub, VS Code, IntelliJ IDEA, NetBeans, entre outras.
...
- Sites responsivos com HTML, CSS, JavaScript e Bootstrap  
- Projetos em C/C++ focados em eficiência  
